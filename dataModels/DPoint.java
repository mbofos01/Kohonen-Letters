 ...
 * </br>
 * It offers the functionality for storing and restoring coordinate values at
 * wanted dimensions. </br>
 * 
 * @author Petar
 *
 */
public class DPoint {
	...
	/**
	 * Sets the coordinates to the given values. </br>
	 * If a null or a field containing a invalid number of coordinates is given a
	...
	public void setCoordinates(@Nonnull double[] coordinates) {
		...
		if (this.coordinates.length != coordinates.length)
			throw new IllegalArgumentException(
					"Invalid coordinates given. The length of the given field is invalid or the field is null.");

		this.coordinates = coordinates;
	}

	/**
	 * Gets the current coordinates. The field returned is a copy of the field
	...
	/**
	 * Returns the value of a coordinate at a specific dimension. If a invalid
	 * dimension is given a {@link IllegalArgumentException} is thrown.
	 * 
	...
	/**
	 * Sets the value of the coordinate at the given dimension. If a invalid
	 * dimension is given a {@link IllegalArgumentException} is thrown.
	 * 
